describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[type="password"]').type('PASSWORD').type('{enter}');// вводим пароль и нажимаем enter
         ...
         cy.wait(2000);                                                  //ждём 2 секунды
         cy.get(':nth-child(3) > .shop__button').click({ force: true }) // Нажимаем на покупку определённого аватара
